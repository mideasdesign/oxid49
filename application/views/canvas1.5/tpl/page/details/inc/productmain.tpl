    ...
    <div class="information">
        ...
        <div class="productMainInfo[{if $oManufacturer->oxmanufacturers__oxicon->value}] hasBrand[{/if}]">
            ...
            [{block name="details_productmain_title"}]
                <h1 id="productTitle">[{$oDetailsProduct->oxarticles__oxtitle->value}] [{$oDetailsProduct->oxarticles__oxvarselect->value}]</h1>
            [{/block}]
        ...
        <div id="productArtnum" class="itemCode">[{oxmultilang ident="DETAILS_ARTNUMBER"}] [{$oDetailsProduct->oxarticles__oxartnum->value}]</div>
            [{/block}]
        ...
        [{block name="details_productmain_shortdesc"}]
            ...
            [{/oxhasrights}]
        [{/block}]
         <div style="margin-left:-5px;text-align:left;margin-top:3px;float:left;">
                           <span style="text-align:left;float:left;font-weight: bold;">&nbsp;&nbsp;Menge:</span><input id="amountToBasket" type="text" name="am" value="1" size="3" autocomplete="off" class="textbox">
                          </div> 
        <div class="clear">&nbsp;</div>
            ...
            [{/block}]
                ...
                [{block name="details_productmain_tobasket"}]
                    [{oxhasrights ident="TOBASKET"}]
                            ...
                            <button id="toBasket" type="submit" [{if !$blCanBuy}]disabled="disabled"[{/if}] class="submitButton1 largeButton" title="[{oxmultilang ident="DETAILS_ADDTOCART"}]"><span style="top:10px;">[{oxmultilang ident="DETAILS_ADDTOCART"}]</span></button>
                           [{/if}]
                    [{/oxhasrights}]
                [{/block}]
