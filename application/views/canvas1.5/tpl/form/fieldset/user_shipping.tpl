...
[{/if}]
<li>
    <ul id="shippingAddressForm" [{if $delivadr }] class="hide"[{/if}]>
        <li>
            <label [{if $oView->isFieldRequired(oxaddress__oxsal) }]class="req"[{/if }]>[{ oxmultilang ident="TITLE" }]</label>
        ...
        <li [{if $aErrors.oxaddress__oxfname}]class="oxInValid"[{/if}]>
            <label [{if $oView->isFieldRequired(oxaddress__oxfname)}]class="req"[{/if}]>[{ oxmultilang ident="FIRST_NAME" }]</label>
        ...
        <li [{if $aErrors.oxaddress__oxlname}]class="oxInValid"[{/if}]>
            <label [{if $oView->isFieldRequired(oxaddress__oxlname)}]class="req"[{/if}]>[{ oxmultilang ident="LAST_NAME" }]</label>
        ...
        <li [{if $aErrors.oxaddress__oxaddinfo}]class="oxInValid"[{/if}]>
            ...
            <label [{if $_address_addinfo_tooltip}]title="[{$_address_addinfo_tooltip}]" class="tooltip"[{/if}] [{if $oView->isFieldRequired(oxaddress__oxaddinfo) }]class="req"[{/if}]>[{ oxmultilang ident="FORM_FIELDSET_USER_SHIPPING_ADDITIONALINFO2" }]</label>
        ...
        <li [{if $aErrors.oxaddress__oxfon}]class="oxInValid"[{/if}]>
            <label [{if $oView->isFieldRequired(oxaddress__oxfon) }]class="req"[{/if}]>[{ oxmultilang ident="PHONE" }]</label>
