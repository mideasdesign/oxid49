            ...
            [{/block}]
                ...
                [{block name="details_productmain_tobasket"}]
                    [{oxhasrights ident="TOBASKET"}]
                            ...
                            <button id="toBasket" type="submit" [{if !$blCanBuy}]disabled="disabled"[{/if}] class="submitButton1 largeButton" title="[{oxmultilang ident="DETAILS_ADDTOCART"}]"><span class="eb_top">[{oxmultilang ident="DETAILS_ADDTOCART"}]</span></button>
                           [{/if}]
                    [{/oxhasrights}]
                [{/block}]
