<dl>
    <dt>
        ...
        <label for="payment_[{$sPaymentID}]">[{ $paymentmethod->oxpayments__oxdesc->value}] [{ if $paymentmethod->dAddPaymentSum }]([{ $paymentmethod->fAddPaymentSum }] [{ $currency->sign}])[{/if}]</label>
    </dt>
