[{block name="checkout_user_options"}]
    ...
    <div  class="checkoutOptions clear eb_user_option_width">
        ...
        [{block name="checkout_options_noreg"}]
            ...
            <div class="lineBox option" id="optionNoRegistration">
                ...
                <h3 class="cart_step_2_header">[{ oxmultilang ident="PAGE_CHECKOUT_USER_OPTION_NOREGISTRATION" }]</h3>
                ...
                <form action="[{ $oViewConf->getSslSelfLink() }]" method="post">
                    <p>
                        ...
                        <button class="submitButton horiz1" type="submit">[{ oxmultilang ident="PAGE_CHECKOUT_USER_OPTION_NEXT" }]</button>
                    </p>
                </form>
        ...
        [{/block}]
         ...
         [{block name="checkout_options_login"}]
            <div class="lineBox option" id="optionLogin">
                ...
                <h3 class="cart_step_2_header">[{ oxmultilang ident="PAGE_CHECKOUT_USER_OPTION_LOGIN" }]</h3>
        ...
        [{block name="checkout_options_reg"}]
            <div class="lineBox option" id="optionRegistration">
                ...
                <h3 class="cart_step_2_header">[{ oxmultilang ident="PAGE_CHECKOUT_USER_OPTION_REGISTRATION" }]</h3>
