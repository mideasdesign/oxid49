...
[{/if}]
    <li>
        <label [{if $oView->isFieldRequired(oxuser__oxsal)}]class="req"[{/if}]>[{ oxmultilang ident="TITLE" }]</label>
    ...
    <li [{if $aErrors.oxuser__oxcountryid}]class="oxInValid"[{/if}]>
        <label [{if $oView->isFieldRequired(oxuser__oxcountryid) }]class="req"[{/if}]>[{ oxmultilang ident="FORM_FIELDSET_USER_BILLING_COUNTRY" }]</label>
          <select [{if $oView->isFieldRequired(oxuser__oxcountryid) }] class="js-oxValidate js-oxValidate_notEmpty selectfield" [{/if}] id="invCountrySelect" name="invadr[oxuser__oxcountryid]">
              <option value="">-</option>
    ...
    <li [{if $aErrors.oxuser__oxfon}]class="oxInValid"[{/if}]>
        <label [{if $oView->isFieldRequired(oxuser__oxfon) }]class="req"[{/if}]>[{ oxmultilang ident="PHONE" }]</label>
